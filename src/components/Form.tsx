...
const Form = () => {
  const { addProduct, selectedProduct, setSelectedProduct, updateProduct } =
    ...
    >
      ...
      <div className="flex gap-2">
        ...
        <button
          ...
          } bg-green-600/80 text-white py-2 px-4 rounded-lg hover:bg-green-600/50 transition duration-300 focus:outline-none focus:ring-0 cursor-pointer`}
        >
          Register
        </button>
      </div>
